    ...
    render() {
        return (
            <div>
                ...
                <input type="radio" name="summons" value={3.8} onChange={this.props.click}/> 2 magna<br/>
                <input type="radio" name="summons" value={2.4} onChange={this.props.click}/> 1 magna<br/>
